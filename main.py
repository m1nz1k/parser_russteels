...
def main():
    ...
    # Список городов
    city_list = ['https://chelyabinsk.russteels.ru/', 'https://voronezh.russteels.ru/', 'https://krasnodar.russteels.ru/', 'https://novorossijsk.russteels.ru/',
                 'https://nalchik.russteels.ru/', 'https://nn.russteels.ru/', 'https://novosibirsk.russteels.ru/', 'https://pyatigorsk.russteels.ru/',
